...
if(((s=r[n]).parsed&&(s=s.el[0]),s===i.el[0])){e.index=n;break}}else(e.items=t.isArray(i.items)?i.items:[i.items]),(e.index=i.index||0);if(!e.isOpen){(e.types=[]),(o=""),i.mainEl&&i.mainEl.length?(e.ev=i.mainEl.eq(0)):(e.ev=a),i.key?(e.popupsCache[i.key]||(e.popupsCache[i.key]={}),(e.currTemplate=e.popupsCache[i.key])):(e.currTemplate={}),(e.st=t.extend(!0,{},t.magnificPopupT4s.defaults,i)),(e.fixedContentPos="auto"===e.st.fixedContentPos?!e.probablyMobile:e.st.fixedContentPos),e.st.modal&&((e.st.closeOnContentClick=!1),(e.st.closeOnBgClick=!1),(e.st.showCloseBtn=!1),(e.st.enableEscapeKey=!1)),e.bgOverlay||((e.bgOverlay=f("bg").on("click.mfp",function(){e.close()})),(e.wrap=f("wrap").attr("tabindex",-1).on("click.mfp",function(t){e._checkIfClose(t.target)&&e.close()})),(e.container=f("container",e.wrap))),(e.contentContainer=f("content")),e.st.preloader&&(e.preloader=f("preloader",e.container,e.st.tLoading));var l=t.magnificPopupT4s.modules;for(n=0;n<l.length;n++){var d=l[n];(d=d.charAt(0).toUpperCase()+d.slice(1)),e["init"+d].call(e)}
p("BeforeOpen"),e.st.showCloseBtn&&(e.st.closeBtnInside?(u("MarkupParse",function(t,e,i,a){i.close_replaceWith=h(a.type)}),(o+=" mfp-close-btn-in")):e.wrap.append(h())),e.st.alignTop&&(o+=" mfp-align-top"),e.fixedContentPos?e.wrap.css({overflow:e.st.overflowY,overflowX:"hidden",overflowY:e.st.overflowY}):e.wrap.css({top:c.scrollTop(),position:"absolute"}),(!1===e.st.fixedBgPos||("auto"===e.st.fixedBgPos&&!e.fixedContentPos))&&e.bgOverlay.css({height:a.height(),position:"absolute"}),e.st.enableEscapeKey&&a.on("keyup.mfp",function(t){27===t.keyCode&&e.close()}),c.on("resize.mfp",function(){e.updateSize()}),e.st.closeOnContentClick||(o+=" mfp-auto-cursor"),o&&e.wrap.addClass(o);var m=(e.wH=c.height()),g={};if(e.fixedContentPos&&e._hasScrollBar(m)){var v=e._getScrollbarSize();v&&(g.marginRight=v)}
e.fixedContentPos&&(e.isIE7?t("body, html").css("overflow","hidden"):(g.overflow="hidden"));var y=e.st.mainClass;return(e.isIE7&&(y+=" mfp-ie7"),y&&e._addClassToMFP(y),e.updateItemHTML(),p("BuildControls"),t("html").css(g),e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo||t(document.body)),(e._lastFocusedEl=document.activeElement),setTimeout(function(){e.content?(e._addClassToMFP("mfp-ready"),e._setFocus()):e.bgOverlay.addClass("mfp-ready"),a.on("focusin.mfp",e._onFocusIn)},16),(e.isOpen=!0),e.updateSize(m),p("Open"),i)}
e.updateItemHTML()},close:function(){e.isOpen&&(p("BeforeClose"),(e.isOpen=!1),e.st.removalDelay&&!e.isLowIE&&e.supportsTransition?(e._addClassToMFP("mfp-removing"),setTimeout(function(){e._close()},e.st.removalDelay)):e._close())},_close:function(){p("Close");var i="mfp-removing mfp-ready ";if((e.bgOverlay.detach(),e.wrap.detach(),e.container.empty(),e.st.mainClass&&(i+=e.st.mainClass+" "),e._removeClassFromMFP(i),e.fixedContentPos)){var n={marginRight:""};e.isIE7?t("body, html").css("overflow",""):(n.overflow=""),t("html").css(n)}
a.off("keyup.mfp focusin.mfp"),e.ev.off(".mfp"),e.wrap.attr("class","mfp-wrap").removeAttr("style"),e.bgOverlay.attr("class","mfp-bg"),e.container.attr("class","mfp-container"),!e.st.showCloseBtn||(e.st.closeBtnInside&&!0!==e.currTemplate[e.currItem.type])||(e.currTemplate.closeBtn&&e.currTemplate.closeBtn.detach()),e.st.autoFocusLast&&e._lastFocusedEl&&t(e._lastFocusedEl).focus(),(e.currItem=null),(e.content=null),(e.currTemplate=null),(e.prevHeight=0),p("AfterClose")},updateSize:function(t){if(e.isIOS){var i=document.documentElement.clientWidth/window.innerWidth,a=window.innerHeight*i;e.wrap.css("height",a),(e.wH=a)}else e.wH=t||c.height();e.fixedContentPos||e.wrap.css("height",e.wH),p("Resize")},updateItemHTML:function(){var i=e.items[e.index];e.contentContainer.detach(),e.content&&e.content.detach(),i.parsed||(i=e.parseEl(e.index));var a=i.type;if((p("BeforeChange",[e.currItem?e.currItem.type:"",a]),(e.currItem=i),!e.currTemplate[a])){var o=!!e.st[a]&&e.st[a].markup;p("FirstMarkupParse",o),(e.currTemplate[a]=!o||t(o))}
n&&n!==i.type&&e.container.removeClass("mfp-"+n+"-holder");var s=e["get"+a.charAt(0).toUpperCase()+a.slice(1)](i,e.currTemplate[a]);e.appendContent(s,a),(i.preloaded=!0),p("Change",i),(n=i.type),e.container.prepend(e.contentContainer),p("AfterChange")},appendContent:function(t,i,a){if(""==t&&"ajax"==i)return!1;(e.content=t),t?(e.st.showCloseBtn&&e.st.closeBtnInside&&!0===e.currTemplate[i]?e.content.find(".mfp-close").length||e.content.append(h()):(e.content=t)):(e.content=""),p("BeforeAppend"),e.container.addClass("mfp-"+i+"-holder"),e.contentContainer.append(e.content)},parseEl:function(i){var a,n=e.items[i];if((n.tagName?(n={el:t(n)}):((a=n.type),(n={data:n,src:n.src})),n.el)){for(var o=e.types,s=0;s<o.length;s++)
if(n.el.hasClass("mfp-"+o[s])){a=o[s];break}(n.src=n.el.attr("data-mfp-src")),n.src||(n.src=n.el.attr("href"))}
return(n.type=a||e.st.type||"inline"),(n.index=i),(n.parsed=!0),(e.items[i]=n),p("ElementParse",n),e.items[i]},addGroup:function(t,i){var a=function(a){(a.mfpEl=this),e._openClick(a,t,i)};i||(i={});var n="click.magnificPopupT4s";(i.mainEl=t),i.items?((i.isObj=!0),t.off(n).on(n,a)):((i.isObj=!1),i.delegate?t.off(n).on(n,i.delegate,a):((i.items=t),t.off(n).on(n,a)))},_openClick:function(i,a,n){if((void 0!==n.midClick?n.midClick:t.magnificPopupT4s.defaults.midClick)||!(2===i.which||i.ctrlKey||i.metaKey||i.altKey||i.shiftKey)){var o=void 0!==n.disableOn?n.disableOn:t.magnificPopupT4s.defaults.disableOn;if(o)
...
var s;(T4SThemeSP.isEditCartReplace&&((this.txt_addToCart=g),(this.txt_preOrder=v)),(this.unQuickShopInline=e.unQuickShopInline),(this.isQuickShopForm=e.isQuickShopForm),(this.$imgMainItem=this.$container.find("[data-main-img-change]")),e.unQuickShopInline)?(this.originalSelectorId.addEventListener("change",this._onSelectChange.bind(this)),this._updateSwatchFromSizeOne(),this.isNoPick?(this.currentVariant=this._getVariantFromVariantid()):this.originalSelectorId.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0}))):((s=this).$container.one("replace:btnAtc",function(){(s.$addToCartButton=s.$container.find(".t4s-pr-addtocart")),(s.$quantityWrapper=s.$container.find("[data-quantity-wrapper]")),(s.$addToCartButtonText=s.$addToCartButton.find(".t4s-text-pr"))}),(a=s.$container.find("[data-product-badge]")),(s.badgeSelector={$onSale:a.find("[data-badge-sale]"),$preOrder:a.find("[data-badge-preorder]"),$soldOut:a.find("[data-badge-soldout]")}),(s.$dataHref=s.$container.find("[data-pr-href]")),(s.productHref=s.$dataHref.attr("href")),(s.currentVariant=s._getVariantFromVariantid()),s.$originalSelectorId.on("change",s._onQuickShopInlineChange.bind(s)),s._updateSwatchFromSizeOne())}
return((w.prototype=Object.assign({},w.prototype,{_onSelectChange:function(){this.eventClickedSwatch||(this.oldVariant=this.currentVariant);var t=this.eventClickedSwatch?this.currentVariant:this._getVariantFromVariantid();this._setVariantState(t),this._updateSwatchSelector(t,this.oldVariant,this.formSelectorId,this.hasSoldoutUnavailable),this._updatePrice(t,this.oldVariant,this.$container),this._updateAddToCartButton(t,this.oldVariant,this.$addToCartButton,this.$quantityWrapper,this.$paymentButton,this.$addToCartButtonText),this._updateAvailability(t,this.oldVariant,this.$container),this._updateSKU(t,this.oldVariant,this.$container),this._updateBarcode(t,this.oldVariant,this.$container),this._updateMetafield(t,this.oldVariant,this.$container),this._updateDelivery(t,this.oldVariant,this.$container),this._updateInventoryQuantity(t,this.oldVariant,this.$container),this._updatePickupAvailabilityContent(t,this.$container),this._updateNotifyBackinStock(t,this.$container),this._updateBadges(),this._updateIncomingMess(t),t&&((this.currentVariant=t),this.canMediaGroup&&this._updateMediaFilter(t,this.oldVariant,this.$container),this._updateMedia(t,this.oldVariant,this.$container),this._updateQuantity(t),this.disableVariantImage||this._updateVariantImageSwatch(t),this.isSticky&&this._updateStickyATC(t),this.enableHistoryState&&this._updateHistoryState(t),this.$container.trigger({type:"variant:changed",currentVariant:t,oldVariant:this.oldVariant}))},_onQuickShopInlineChange:function(){(this.notSelected=!0),this.eventClickedSwatch||(this.oldVariant=this.currentVariant);var t=this.eventClickedSwatch?this.currentVariant:this._getVariantFromVariantid();this._setVariantState(t),this._updateSwatchSelector(t,this.oldVariant,this.formSelectorId,this.hasSoldoutUnavailable),this._updatePrice(t,this.oldVariant,this.$container),this._updateAtcBtnQSInline(t,this.oldVariant,this.$addToCartButton,this.$quantityWrapper,this.$addToCartButtonText),this._updateBadges(),t&&((this.currentVariant=t),this._updateMedia(t,this.oldVariant,this.$container),this._updateQuantity(t),this.$dataHref.attr("href",this._getUrlWithVariant(this.productHref,t.id)),this.disableVariantImage||this._updateVariantImageSwatch(t),this.$container.trigger({type:"variant:changed",currentVariant:t,oldVariant:this.oldVariant}))},_getVariantFromOptions:function(){var t=this.clickedOptions;return(this.variants.find(function(e){return t.every(function(t){return e[t.index]===t.value})})||"nathan")},_getVariantFromSize:function(){var e,i=this.variants,a=this.productOptionSize,n=this.removeSoldout,o=this.clickedOptions[0].value,s=this.clickedOptions[1],r=(this.clickedOptions[2],this.clickedCurrentValue),l=this.clickedCurrentIndex;return(1==a?(e=t.grep(i,function(t,e){return t.available})):(3==a)&n?((s=s.value),(e=t.grep(i,function(t,e){return t.option1==o&&t.option2==s&&t.available}))[0]||(e=t.grep(i,function(t,e){return t.available&&t[l]==r}))):n?(e=t.grep(i,function(t,e){return t.option1==o&&t.available}))[0]||(e=t.grep(i,function(t,e){return t.available&&t[l]==r})):3==a?((s=s.value),(e=t.grep(i,function(t,e){return t.option1==o&&t.option2==s}))[0]||(e=t.grep(i,function(t,e){return t[l]==r}))):(e=t.grep(i,function(t,e){return t.option1==o}))[0]||(e=t.grep(i,function(t,e){return t[l]==r})),e[0])},_getVariantFromVariantid:function(){var t=[],e=this.variants,i=e.length,a=this.$originalSelectorId.val();for(let n=0;n<i;n++)
if(e[n].id==a){t[0]=e[n];break}
return t[0]||null},_getVariantFromOptionIndex:function(e,i){var a,n=this.variants,o=i.option1,s=i.option2,r=i.option3;switch(e){case 1:a=t.grep(n,function(t,e){return t.option1==o});break;case 2:a=t.grep(n,function(t,e){return t.option2==s});break;case 3:a=t.grep(n,function(t,e){return t.option3==r});break;case 1.2:a=t.grep(n,function(t,e){return t.option1==o&&t.option2==s});break;default:a=t.grep(n,function(t,e){return 0==t.available})}
return a||"nathan"},_updateMediaFilterNoPick:function(){if(this.clickedCurrentValue&&this.clickedCurrentIndex&&this.canMediaGroup){var t=this.clickedCurrentIndex.replace("option",""),e=this.productOptions[parseInt(t)-1].name||"not4s",i=this.clickedCurrentValue||"not4s",a=this.$mainMedia,n=this.$mainNav,o=`[data-grname="${(e + "").toLowerCase()}"][data-grpvl="${(i + "").toLowerCase()}"]`,s=a.find(o),r=n.find(o);0!=s.length&&(a.find("[data-main-slide]").addClass(c),s.removeClass(c),n.find(".t4s-carousel__nav-item").addClass(c),r.removeClass(c),a.hasClass("flickityt4s-enabled")?(a.trigger("update.flickityt4s"),r.hasClass(l)||r.first().addClass(l)):a.hasClass("isotopet4s-enabled")&&(x(a),a.isotopet4s()))}},_updateSwatchFromSizeOne:function(){var t,e=this,i=e.variants,n=i.length,o=!1,s=0,r=e.productOptionSize,l=e.productOptions;if(3==r)
var d=l[0].values.length,c=l[1].values.length,u=l[2].values.length;else if(2==r)(d=l[0].values.length),(c=l[1].values.length);if((r<2?((o=1),(t=e.$options1)):2==r&&1==d?((o=1),(t=e.$options2),(s=1)):2==r&&1==c?((o=1),(t=e.$options1)):3==r&&1==d&&1==c?((o=1),(t=e.$options3),(s=2)):3==r&&1==d&&1==u?((o=1),(t=e.$options2),(s=1)):3==r&&1==c&&1==u?((o=1),(t=e.$options1)):3==r&&1==u&&(o=2),e.hasSoldoutUnavailable)){let t=l[s].values,o=t.length,r=e[`$options${s + 1}`].find("[data-swatch-item]");for(let e=0;e<o;e++){let o=!0,l=t[e];for(let t=0;t<n;t++){let e=i[t];if(e.options[s]==l&&e.available){o=!1;break}}
o&&r.eq(e).addClass(a)}}(e.getProductSize=o),(e.$optionsOne=t),(e.$optionsOneIndex=s)},_updateMediaFilter:function(t,e,i){if(this.currentVariant&&this.canMediaGroup){var a,n,o,s,r,l=this.productOptions,d=this.productOptionSize,u=this.currentVariant,f=this.$mainMedia,p=this.$mainNav;for(let t=0;t<d;t++)
if(((s=l[t].name||"not4s"),0!=f.find(`[data-grname="${(s + "").toLowerCase()}"]`).length)){(r=u.options[t]+""),(a=`[data-grname="${(s + "").toLowerCase()}"][data-grpvl="${r.toLowerCase()}"]`);break}
if(((n=f.find(a)),(o=p.find(a)),0!=n.length&&r!=this.groupValue))
if(((this.groupValue=r),f.find("[data-main-slide]").addClass(c),n.removeClass(c),p.find(".t4s-carousel__nav-item").addClass(c),o.removeClass(c),f.hasClass("flickityt4s-enabled"))){f.trigger("update.flickityt4s");var h=t.featured_media?f.find(`[data-media-id="${t.featured_media.id}"]:visible`).index():0;f.flickityt4s("selectCell",Math.max(h,0),!1,!1)}else f.hasClass("isotopet4s-enabled")&&(x(f),f.isotopet4s())}},_updateSwatchSelector:function(t,a,o,l){var c,u,f,p,h,m,g,v=this,y=1,b=v.$options1,S=v.$options2,w=v.$options3,_=v.getProductSize||v.productOptionSize,T=[],$=0,C=t.option1,k=t.option2,I=t.option3,x=[],P=[],M=[];if((o.find(r).removeClass(d),o.find(i).html(""),(x=v.productOptions[0].values),b.find(i).html(C),b.find(e).eq(x.indexOf(C)).addClass(d),S[0]&&((P=v.productOptions[1].values),S.find(i).html(k),S.find(e).eq(P.indexOf(k)).addClass(d)),w[0]&&((M=v.productOptions[2].values),w.find(i).html(I),w.find(e).eq(M.indexOf(I)).addClass(d)),l))
switch(_){case 3:for(1==M.length?((c=b),(u=x),(f="option3"),(p=I),(h="option1"),(y=3)):((c=w),(u=M),(f="option1"),(p=C),(h="option3")),$=(T=this._getVariantFromOptionIndex(y,t)).length,c.find(e).addClass(s),S.find(e).addClass(s),g=0;g<$;g++)(m=T[g])[f]==p&&(m.available?(S.find(e).eq(P.indexOf(m.option2)).removeClass(s),m.option2==k&&c.find(e).eq(u.indexOf(m[h])).removeClass(s)):(S.find(e).eq(P.indexOf(m.option2)).removeClass(n),m.option2==k&&c.find(e).eq(u.indexOf(m[h])).removeClass(n)));break;case 2:for($=(T=this._getVariantFromOptionIndex(1,t)).length,S.find(e).addClass(s),g=0;g<$;g++)(m=T[g]).option1==C&&S.find(e).eq(P.indexOf(m.option2)).removeClass(m.available?s:n);break;default:v.removeSoldout&&v.$optionsOne.find(r).is(":hidden")&&v.$optionsOne.find(`${e}:visible:first`).trigger("click")}},_updateMetafield:function(e,i,a){e&&e.id!=i.id&&(a.find("[data-variant-toggle]").hide(),a.find(`[data-variant-toggle="${e.id}"]`).show(),this.isMainProduct&&(t("[data-variant-tab][data-variant-toggle]").hide(),t(`[data-variant-tab][data-variant-toggle="${e.id}"]`).show()))},_updateMedia:function(t,e,i){console.log("Ejecutando _updateMedia para la variante:",t);if(t.featured_media&&JSON.stringify(t.featured_media)!==JSON.stringify(e.featured_media)&&!this.showFirstMedia){if(!this.unQuickShopInline||this.isQuickShopForm){let e=t.featured_media.preview_image,i=!0,a=this.$imgMainItem.hasClass("lazyloadt4sed")&&i?0:100;return(setTimeout(function(){this.$imgMainItem.attr("data-srcset",T4SThemeSP.Images.getNewImageUrl(e.src,1)),(i=!1)}.bind(this),a),void(this.notSelected&&(this.$container.addClass("t4s-colors-selected"),(this.notSelected=!1))))}
this.mediaID=t.featured_media.id;var a=i.find("[data-main-media]");if(a.hasClass("flickityt4s-enabled")){var n=a.find('[data-media-id="'+this.mediaID+'"]:visible').index();a.flickityt4s("select",Math.max(n,0),!1,!0),(this.eventClickedSwatch=!1)}else if(!a.hasClass("t4s-of-scrollIntoView")){var o=a.find('[data-media-id="'+this.mediaID+'"]'),s=o[0];if(!s||T4SThemeSP.isVisible(o)||this.isStickyChanging)return;this.header||(this.header=document.querySelector(".t4s-section-header")),this.header.dispatchEvent(new Event("preventHeaderReveal")),window.setTimeout(()=>{(a[0].scrollLeft=0),s.scrollIntoView({behavior:"smooth"})})}}else this.showFirstMedia=!1},(function(){var originalUpdateMedia=T4SThemeSP.Product.prototype._updateMedia;T4SThemeSP.Product.prototype._updateMedia=function(t,e,i){originalUpdateMedia.apply(this,arguments);console.log("✅ Post _updateMedia - Asegurando actualización de imagen...");let $imgMain=this.$imgMainItem;if($imgMain.attr("data-srcset")!==T4SThemeSP.Images.getNewImageUrl(t.featured_media.src,1)){console.log("🔄 Forzando actualización de la imagen...");$imgMain.attr("data-srcset",T4SThemeSP.Images.getNewImageUrl(t.featured_media.src,1));$imgMain.attr("src",T4SThemeSP.Images.getNewImageUrl(t.featured_media.src,1))}
var $mediaContainer=i.find("[data-main-media]");if($mediaContainer.hasClass("flickityt4s-enabled")){console.log("📸 Recargando carrusel de imágenes...");$mediaContainer.flickityt4s("reloadCells")}}})(),_updateMediaFirst:function(t){if(this.unQuickShopInline)return;var e=t.closest("[data-swatch-option]");if(!e.hasClass("is-t4s-style__color"))return;let i=this.variants,a=i.length,n=e.data("id");let o=(function(t){for(let e=0;e<a;e++){let a=i[e];if(a.featured_media&&(a.options[n]+"").toLowerCase()==t)return a.featured_media.preview_image}})((t.data("value")+"").toLowerCase());o&&this.$imgMainItem.attr("data-srcset",T4SThemeSP.Images.getNewImageUrl(o.src,1))},_updatePrice:function(t,e,i){if(!t)return void this.$productPrice.hide();let a=t.price,n=t.compare_at_price;if(!this.isNoPickOriginal&&a===e.price&&n===e.compare_at_price&&t.unit_price===e.unit_price)return;this.isNoPickOriginal&&(this.isNoPickOriginal=!1);let s=T4SThemeSP.Currency.formatMoney(a);if((this.$productPrice.show(),this.variantState.onSale)){let t=T4SThemeSP.Currency.formatMoney(n),e=this.formartPrice.replace("money_ins",s).replace("money_del",t),i=n-a,o=(100*i)/n,r=Math.round(o);void 0!==u.price_template&&(e=u.price_template.replace("INS",s).replace("DEL",t)),this.isSticky&&this.$stickyPrice.html(e),this.badgeSelector.$onSale.html(this.saleLabel.replace("[sale]",r)),"1"==this.saletype?(e+=` <span class="t4s-badge-price">${y.replace("[sale]", r)}</span>`):"2"==this.saletype&&(e+=` <span class="t4s-badge-price">${b.replace("[sale]", T4SThemeSP.Currency.formatMoney(i))}</span>`),this.$productPrice.html(e)}else this.$productPrice.html(s),this.isSticky&&this.$stickyPrice.html(s);this.variantState.showUnitPrice&&(this.$unit_price.html(T4SThemeSP.Currency.formatMoney(t.unit_price)),this.$unit_base.html(T4SThemeSP.Currency.getBaseUnit(t))),this.$container.find("shopify-payment-terms").attr("variant-id",t.id),o.trigger("currency:update")},_updateQuantity:function(t){var e=t.quantity_rule?t.quantity_rule.min:1,i=t.quantity_rule&&t.quantity_rule.max?t.quantity_rule.max:9999;if(this.variantState.preOrder)this.$quantity.attr({min:e,max:i}),this.isSticky&&this.$stickyQuantity.attr({min:e,max:i});else if(null!=t.inventory_management&&"continue"!=t.inventory_policy){let a=t.inventory_quantity;a<i&&(i=a),this.$quantity.attr({min:e,max:i}),this.isSticky&&this.$stickyQuantity.attr({min:e,max:i}),parseInt(this.$quantity.val())>a&&this.$quantity.attr("value",1).val(1),this.isSticky&&parseInt(this.$stickyQuantity.val())>a&&this.$stickyQuantity.attr("value",1).val(1)}else this.$quantity.attr({min:e,max:i}),this.isSticky&&this.$stickyQuantity.attr({min:e,max:i})},_updateAvailability:function(t,e,i){var a=i.find("[data-product-available]");if(a[0]){var n=a.find("[data-available-status]"),o=a.find("[data-soldout-status]"),s=a.find("[data-instock-status]"),r=a.find("[data-preorder-status]");t?(a.show(),this.variantState.available?(n.show(),o.hide(),this.variantState.preOrder?(r.show(),s.hide()):(s.show(),r.hide())):(o.show(),n.hide())):a.hide()}},_updateBarcode:function(t,e,i){var a=i.find("[data-product-barcode]");if(a[0]){var n=a.find("[data-product__barcode-number]");if(t&&""!==t.barcode){if(e&&e.barcode===t.barcode)return;n.text(t.barcode),a.show(0)}else a.hide(0)}},_updateSKU:function(t,e,i){var a=i.find("[data-product-sku]");if(a[0]){var n=a.find("[data-product__sku-number]");if(t&&""!==t.sku){if(e&&e.sku===t.sku)return;n.text(t.sku),a.show(0)}else a.hide(0)}},_updateAddToCartButton:function(t,e,i,a,n,o){if(i[0]||n[0])
if((T4SThemeSP.isEditCartReplace&&!i.is("[data-replace-item]")&&i.attr("data-replace-item",""),t&&"nathan"!=t))
if(t.available){let t=this.variantState.preOrder?this.txt_preOrder||m:this.txt_addToCart||p;a.show(),i.removeAttr("disabled "+S).attr("data-atc-form",""),o.text(t),n.show(),this.isSticky&&(this.$stickyQuantityWrapper.show(),this.$stickyATC.removeAttr("disabled "+S),this.$stickyATCText.text(t))}else a.hide(),i.attr("disabled","disabled").attr(S,!0).removeAttr("data-atc-form",""),o.text(h),n.hide(),this.isSticky&&(this.$stickyQuantityWrapper.hide(),this.$stickyATC.attr("disabled","disabled").attr(S,!0),this.$stickyATCText.text(h));else i.attr("disabled","disabled").attr(S,!0).removeAttr("data-atc-form"),o.text(f),a.hide(),n.hide(),this.isSticky&&(this.$stickyQuantityWrapper.hide(),this.$stickyATC.attr("disabled","disabled").attr(S,!0),this.$stickyATCText.text(f))},_updateAtcBtnQSInline:function(t,e,i,a,n){if(i[0])
if(t&&"nathan"!=t)
if(t.available){let e=this.variantState.preOrder?this.txt_preOrder||m:this.txt_addToCart||p;a.show(),i.removeAttr("disabled "+S).attr("data-action-atc","").attr("data-variant-id",t.id),n.text(e)}else a.hide(),i.attr("disabled","disabled").attr(S,!0).removeAttr("data-action-atc",""),n.text(h);else i.attr("disabled","disabled").attr(S,!0).removeAttr("data-action-atc"),n.text(f),a.hide()},_updateDelivery:function(t,e,i){var a="data-order-delivery",n=i.find("["+a+"]");if(n[0])
if(t&&t.available){var o=P(n.attr(a));this.variantState.preOrder&&o.hideWithPreorder?n.hide():n.show()}else n.hide()},_updateInventoryQuantity:function(t,e,i){var a=i.find("[data-inventory-qty]");a[0]&&(t&&t.available?a.trigger({type:"variant:inventory",currentVariant:t,oldVariant:this.oldVariant}):a.hide())},_updatePickupAvailabilityContent:function(t,e){let i=t.available?"pickupAvailability:update":"pickupAvailability:clear";e.trigger({type:i,currentVariant:t})},_updateNotifyBackinStock:function(t,e){let i=this.variantState.available?"notifyBackinStock:hide":"notifyBackinStock:show";e.trigger({type:i,currentVariant:t})},_updateBadges:function(){let t=this.variantState,e=this.badgeSelector;t.onSale?e.$onSale.removeAttr("hidden"):e.$onSale.attr("hidden",!0),t.preOrder?e.$preOrder.removeAttr("hidden"):e.$preOrder.attr("hidden",!0),t.soldOut?e.$soldOut.removeAttr("hidden"):e.$soldOut.attr("hidden",!0)},_setVariantState:function(t){t?(this.variantState={available:t.available,soldOut:!t.available,onSale:t.compare_at_price>t.price,showUnitPrice:!!t.unit_price,preOrder:"shopify"==t.inventory_management&&t.inventory_quantity<=0&&t.available,}):(this.variantState.available=!1)},_updateVariantImageSwatch:function(t){if(!t.featured_image)return;let e=this.$variantImg.find(r),i=e.find("[data-img-el]");(e=i[0]?i:e),e.attr("data-bg",T4SThemeSP.Images.getNewImageUrl(t.featured_image.src,this.swatchWidth))},_updateIncomingMess:function(t){if(!this.useComingMess)return;let e=t.next_incoming_date,i=t.inventory_quantity,a=t.incoming,n=t.inventory_management;t&&e&&!(i>0)&&a&&"shopify"==n?(this.$incomingMess.removeAttr("hidden"),this.variantState.available?(this.$incomingAvailableDate.html(e),this.$incomingSoldout.hide(),this.$incomingAvailable.show()):(this.$incomingSoldoutDate.html(e),this.$incomingAvailable.hide(),this.$incomingSoldout.show())):this.$incomingMess.attr("hidden","")},_updateStickyATC:function(t){(this.isStickyChanging=!1),this.$stickyimg.attr("data-src",t.featured_image?T4SThemeSP.Images.lazyloadImagePath(t.featured_image.src):this.stickyImgOrginal),this.useStickySelect?t.available&&(this.$stickyVtitle.find("[data-dropdown-open]>span").text(t.title),this.$stickySelect.find("[data-dropdown-item]").removeClass("is--selected"),this.$stickySelect.find(`[data-dropdown-item][data-value="${t.id}"]`).addClass("is--selected")):this.$stickyVtitle.html(t.title),this.$stickyATC.attr("data-variant-id",t.id)},_updateHistoryState:function(t){if(!history.replaceState||!t)return;let e=new URL(document.location);e.searchParams.set("variant",t.id),window.history.replaceState({path:e.href},"",e.href)},_getUrlWithVariant:function(t,e){return/variant=/.test(t)?t.replace(/(variant=)[^&]+/,"$1"+e):/\?/.test(t)?t.concat("&variant=").concat(e):t.concat("?variant=").concat(e)},})),w)})(),_=(function(){var e="data-live-view",i="data-flash-sold",a="data-animation-atc",n="data-order-delivery",o=T4Sconfigs.timezone,s="t4_nt_guess",r="data-inventory-qty";try{s=dayjs.tz.guess()}catch(t){}
var d="not4"!=o&&s!=o;function c(t){(this.$container=t),this.BootSalesInt()}
function u(t){if(0!=t.length){var e=P(t.attr(a)),i=e.ani;if("none"!=i){var n="is--animated "+i,o=parseInt(e.time),s=parseInt(e.animTime)||1e3;setInterval(function(){t.addClass(n),setTimeout(function(){t.removeClass(n)},s)},o)}}}
return((c.prototype=Object.assign({},c.prototype,{BootSalesInt:function(){this._liveView(),this._flashSold(),this._animationATC(),this._orderDelivery(),this._inventoryQuantity(),this._countdown()},_getRandomInt:function(t,e){return Math.floor(Math.random()*(e-t+1))+t},_animationATC:function(){var t=this.$container.find("["+a+"]");return u(t),void t.length},_liveView:function(){var t=this.$container.find("["+e+"]");if(0!=t.length){var i=P(t.attr(e)),a=this,n=i.min,o=i.max,s=i.interval,r=a._getRandomInt(n,o),l=["1","2","4","3","6","10","-1","-3","-2","-4","-6"],d=["10","20","15"],c="",u="",f="",p=t.find("[data-count]");h(),t.show(),setInterval(h,s)}
function h(){((c=Math.floor(Math.random()*l.length)),(u=l[c]),(r=parseInt(r)+parseInt(u)),n>=r)&&((f=Math.floor(Math.random()*d.length)),(r+=d[f]));(r<n||r>o)&&(r=a._getRandomInt(n,o)),p.html(parseInt(r))}},_flashSold:function(){var t=this.$container.find("["+i+"]");if(0!=t.length){var e=P(t.attr(i)),a=this,n=e.mins,o=e.maxs,s=e.mint,r=e.maxt,l=e.id,d=sessionStorage.getItem("soldS"+l)||a._getRandomInt(n,o),c=sessionStorage.getItem("soldT"+l)||a._getRandomInt(s,r),u=parseInt(d),f=parseInt(c),p=parseInt(e.time),h=t.find("[data-sold]"),m=t.find("[data-hour]");v(),g(u,f),t.show(),setInterval(function(){(u+=a._getRandomInt(1,4)),(f+=1*(Math.random()*(0.8-0.1)+0.1).toFixed(1)),v(),g(u,f)},p)}
function g(t,e){h.html(t),m.html(Math.floor(f)),sessionStorage.setItem("soldS"+l,t),sessionStorage.setItem("soldT"+l,e)}
function v(){u>o&&(u=a._getRandomInt(n,o)),f>r&&(f=a._getRandomInt(s,r))}},_orderDelivery:function(){var e=this.$container.find("["+n+"]");if(0!=e.length){var i=P(e.attr(n)),a=i.format_day,s=i.time.replace("24:00:00","23:59:59")||"19041994",r=["SUN","MON","TUE","WED","THU","FRI","SAT"],l=i.estimateStartDate||0,c=i.estimateEndDate||0,u=i.cut_day.replace(/ /g,"").split(","),f=["280/12","100/01"],p=dayjs(),h=0,m=dayjs(),g=0,v=i.timezone,y=dayjs(),b=y.format("HHmmss"),S=s.replace(/ /g,"").replace(/:/g,""),w=T4SProductStrings.order_dayNames.replace(/ /g,"").split(","),_=T4SProductStrings.order_monthNames.replace(/ /g,"").split(",");if(d&&v)
try{b=(y=dayjs.tz(y,o)).format("HHmmss")}catch(t){console.log("Timezone error: "+o)}
if((parseInt(b)>=parseInt(S)&&((y=y.add(1,"day")),(p=p.add(1,"day")),(m=m.add(1,"day"))),"2"==i.mode)){for(;u.indexOf(r[p.format("d")])>-1||f.indexOf(p.format("DD/MM"))>-1;)p=p.add(1,"day");for(;h<l;)h++,(p=p.add(1,"day")),(u.indexOf(r[p.format("d")])>-1||f.indexOf(p.format("DD/MM"))>-1)&&h--;for(;u.indexOf(r[m.format("d")])>-1;)m=m.add(1,"day");for(;g<c;)g++,(m=m.add(1,"day")),u.indexOf(r[m.format("d")])>-1&&g--}else{for(p=p.add(l,"day");u.indexOf(r[p.format("d")])>-1||f.indexOf(p.format("DD/MM"))>-1;)p=p.add(1,"day");for(m=m.add(c,"day");u.indexOf(r[m.format("d")])>-1;)m=m.add(1,"day");}(w=A(w)),(_=A(_));var T=parseInt(p.format("D")),$=T+L(T),C=_[parseInt(p.format("M"))-1],k=w[parseInt(p.format("d"))],I=parseInt(m.format("D")),x=I+L(I),M=_[parseInt(m.format("M"))-1],O=w[parseInt(m.format("d"))];if((e.find("[data-start-delivery]").html(p.format(a).replace("t44",k).replace("t45",$).replace("t46",C)),e.find("[data-end-delivery]").html(m.format(a).replace("t44",O).replace("t45",x).replace("t46",M)),"19041994"!=s)){var V=e.find("[data-hour-delivery]");V.countdown(y.format("YYYY-MM-DD "+s),{elapse:!0}).on("update.countdown",function(i){if(i.elapsed)e.hide();else{var a=24*i.offset.totalDays+i.offset.hours;V.html(i.strftime(t.trim(V.html().replace("[totalHours]",a)))).show()}})}
e.show()}
function A(t){return t.filter(function(t,e,i){return i.indexOf(t)===e})}
function L(t){if(t>3&&t<21)return"th";switch(t%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}},_inventoryQuantity:function(){var t=this.$container.find("["+r+"]");if(0!=t.length){t.removeAttr("data-ttcalc");var e=P(t.attr(r)),i=this,a=e.stock,n=e.qty,o=e.total,s=e.min,d=e.max,c=e.reduce,u=e.bgprocess,f=e.bgten,p=e.id,h=e.inventoryQty||0,m=null,g=null,v=i._getRandomInt(s,d),y=t.find("[data-count]"),b=t.find("[data-progressbar]"),S=t.find("[data-message]"),w=b.find(">div");if((t.on("variant:inventory",function(e){if("2"!=a){var o=e.currentVariant,r=o.inventory_quantity||0;if(((p=o.id),(r>=n||r<1)&&"1"==a))t.hide();else{(r>=n||0==r)&&isStorageSpSession&&((r=sessionStorage.getItem("probar"+p)||i._getRandomInt(s,d)),t.attr("data-variant-qty"+p,r)),t.attr("data-variant-qty"+p,r),sessionStorage.setItem("probar"+p,r),y.text(r);var l=(100*r)/t.attr("data-ttcalc"),c=r<10?f:u;w.css({"background-color":c,width:l+"%"}),S.show(),b.show(),t.show()}}else t.show()}),!(h>=n||h<1)||"1"!=a)){if((h<n&&h>0&&"2"!==a&&(v=h),isStorageSpSession&&!l&&"1"!=a)){var _=sessionStorage.getItem("probar"+p);_>0&&(v=_)}
y.text(v).css({"background-color":"#fff",color:u}),T(v,u,f),S.show(),b.show(),(function(){if(!c)return;(m=setTimeout(function(){--v<1&&(v=$(t.attr("data-variant-qty"+p))||i._getRandomInt(s,d)),y.css({"background-color":u,color:"#fff"}),setTimeout(function(){y.css({"background-color":"#fff",color:u})},1800),y.text(v),T(v,u,f)},10200)),(g=setInterval(function(){--v<1&&((v=$(t.attr("data-variant-qty"+p))||i._getRandomInt(s,d)),t.on("destroy:inventoryQty").hide()),y.css({"background-color":u,color:"#fff"}),setTimeout(function(){y.css({"background-color":"#fff",color:u})},1800),y.text(v),T(v,u,f)},102e3))})(),t.on("destroy:inventoryQty",function(){clearTimeout(m),clearInterval(g)}),t.on("update:inventoryQty",function(){var e=parseInt(y.text())-1;if(!(e<1)){y.text(e);var i=(100*e)/t.attr("data-ttcalc"),a=e<10?f:u;w.css({"background-color":a,width:i+"%"})}})}}
function T(e,i,a){(e=parseInt(e)),isStorageSpSession&&sessionStorage.setItem("probar"+p,e),(o=t.attr("data-ttcalc")||o>e?o:e+o),t.attr("data-ttcalc",o);var n=(100*e)/o,s=e<10?a:i;w.css("background-color",s),setTimeout(function(){w.css("width",n+"%")},300),w.css("background-color",s)}
function $(t){return t||0}},_countdown:function(){var t=this.$container.find("[data-countdown-pr]");if(0!=t.length){var e,i="data-cd-options",a=t.find("["+i+"]"),n=P(a.attr(i));if(!n.isCountdownMeta){e=n.cd_date.replace("24:00:00","23:59:59").split(",");var s,r,l=dayjs(),c=l.format("HHmmss"),u=e.length;if(d)
try{c=(l=dayjs.tz(l,o)).format("HHmmss")}catch(t){console.log("Timezone error: "+o)}
for(s=0;s<u;s++){if(parseInt(e[s].replace(/:/g,""))>=c){r=e[s];break}
s==u-1&&(r=e[s])}
a.attr("data-date",l.format("YYYY-MM-DD")+" "+r)}
a.attr("data-countdown-t4s",""),T4SThemeSP.Countdown()}},})),{init:c,ani:u})})(),T=(function(){var t={},e={shopify:"shopify",external:"external"},i={productMediaWrapper:"[data-product-single-media-wrapper]"},a={enableVideoLooping:"enable-video-looping",enableVideoMuting:"enable-video-muting",enableVideoAutoplaying:"enable-video-autoplaying",videoId:"video-id"};function n(i){i?(function(){for(var i in t)
if(t.hasOwnProperty(i)){var a=t[i];if(a.nativeVideo)continue;a.host===e.shopify&&(a.element.setAttribute("controls","controls"),(a.nativeVideo=!0))}})():s()}
function o(t){return"VIDEO"===t.tagName?e.shopify:e.external}
function s(){for(var e in t){if(t.hasOwnProperty(e))t[e].ready();}}
return{init:function(e,s){if(e){var r=e.querySelector("iframe, video");if(r){var l=e.getAttribute("data-nt-media-id");(t[l]={mediaId:l,sectionId:s,host:o(r),container:e,element:r,ready:function(){!(function(t){if(t.player)return;var e=t.container.closest(i.productMediaWrapper),n="true"===e.getAttribute("data-"+a.enableVideoLooping),o="true"===e.getAttribute("data-"+a.enableVideoMuting),s="true"===e.getAttribute("data-"+a.enableVideoAutoplaying);(t.player=new Shopify.Video(t.element,{loop:{active:n},muted:o})),e.classList.add("is-media__initialized");var r=function(){t.player&&t.player.pause()};e.addEventListener("mediaHidden",r),e.addEventListener("xrLaunch",r),e.addEventListener("mediaVisible",function(){!T4SThemeSP.isTouch&&s&&t.player&&t.player.play()})})(this)},}),window.Shopify.loadFeatures([{name:"video-ui",version:"2.0",onLoad:n}]),T4SThemeSP.LibraryLoader.load("plyrShopifyStyles")}}},hosts:e,loadVideos:s,removeSectionVideos:function(e){for(var i in t)
if(t.hasOwnProperty(i)){var a=t[i];a.sectionId===e&&(a.player&&a.player.destroy(),delete t[i])}},}})(),$=(function(){var t={},e={},i={},a="[data-product-single-media-group]",n="[data-shopify-xr]";function o(e){if(!e)
if(window.ShopifyXR){for(var i in t)
if(t.hasOwnProperty(i)){var a=t[i];if(a.loaded)continue;var n=document.querySelector("#ModelJson-"+i);window.ShopifyXR.addModels(JSON.parse(n.innerHTML)),(a.loaded=!0)}
window.ShopifyXR.setupXRElements()}else document.addEventListener("shopify_xr_initialized",function(){o()})}
function s(t){if(!t)
for(var i in e)
if(e.hasOwnProperty(i)){var a=e[i];a.modelViewerUi||(a.modelViewerUi=new Shopify.ModelViewerUI(a.element)),r(a)}}
function r(t){var e=i[t.sectionId];t.container.classList.add("is-media__initialized"),t.container.addEventListener("mediaVisible",function(){e.element&&e.element.setAttribute("data-shopify-model3d-id",t.modelId),T4SThemeSP.isTouch||t.modelViewerUi.play()}),t.container.addEventListener("mediaHidden",function(){e.element&&e.element.setAttribute("data-shopify-model3d-id",e.defaultId),t.modelViewerUi.pause()}),t.container.addEventListener("xrLaunch",function(){t.modelViewerUi.pause()})}
return{init:function(r,l){(t[l]={loaded:!1}),r.forEach(function(t,o){var s=t.getAttribute("data-nt-media-id"),r=t.querySelector("model-viewer"),d=r.getAttribute("data-model-id");if(0===o){var c=t.closest(a).querySelector(n);i[l]={element:c,defaultId:d}}
e[s]={modelId:d,sectionId:l,container:t,element:r}}),window.Shopify.loadFeatures([{name:"shopify-xr",version:"1.0",onLoad:o},{name:"model-viewer-ui",version:"1.0",onLoad:s},]),T4SThemeSP.LibraryLoader.load("modelViewerUiStyles")},removeSectionModels:function(i){for(var a in e){if(e.hasOwnProperty(a))e[a].sectionId===i&&(e[a].modelViewerUi.destroy(),delete e[a]);}
delete t[i]},}})(),C=(function(){var e=!1;function i(e,i){e=e[0];let a=JSON.parse(document.querySelector("#Json360-"+i).innerHTML),n=a.imgArray,o=parseFloat(e.getAttribute("data-min"))||1.194,s=parseFloat(e.getAttribute("data-max"))||2,r=window.devicePixelRatio<o?o:window.devicePixelRatio,l=r>s?s:r,d=Math.round(e.clientWidth*l);a.imgArray=[];for(let t in n)a.imgArray.push(`${n[t]}&width=${d}`);a.onReady=function(){!(function(e,i){i.classList.add("is-media__initialized"),i.addEventListener("mediaVisible",function(){if(!T4SThemeSP.isTouch)
